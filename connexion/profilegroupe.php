    ...
    <div class="  row-6 d-flex  ">        
        ...
        <div class="card card card-outline col mr-4 ">
            <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Groupe</p>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="project-actions text-right">
                    ...
                    <a class="btn btn-info btn-sm" href="updatedisk.php?id=<?=$row['id']?>&type=groupe">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="deletedisk.php?id=<?=$row['id']?>&type=groupe">
